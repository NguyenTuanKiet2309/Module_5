...
export default function CustomerEdit() {
  ...
  const handleSubmit = async (values) => {
    console.log("zxc")
    const type = await getTypeCustomerById(values);
    const obj = {
      ...values,
      customer_type: type,
    };
    try {
      await EditCustomer(customer.id,obj); // Gọi API để thêm mới khách hàng
      Swal.fire({
        title: " Created!",
                ...
                <div className="row gutters">
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      ...
                      <Field as="select" className="form-control" name="customer_type">
